...
COPY public.users (id, login, password, user_name, registration_date, questions_asked, answers, comments, reputation) FROM stdin;
1	tomek@tomek.pl	haslo	Tomek	2020-03-17 17:18:19	0	0	0	45
4	45@tom.pl	ertert	Mombo	2019-01-12 23:20:15	6	7	8	0
\.
...
--
-- Name: users myuniqueconstraint; Type: CONSTRAINT; Schema: public; Owner: Tomek
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT myuniqueconstraint UNIQUE (user_name);
